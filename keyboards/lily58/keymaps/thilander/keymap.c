...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,   KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_BSLS,
                            KC_LGUI, MO(_LOWER), KC_LALT, KC_SPC,      KC_ENT, KC_BSPC, MO(_RAISE), TG(_QWERTY_SWE)
    ),
    [_RAISE] = LAYOUT(
        KC_ESC , KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,     KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_BSPC,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                   KC_TRNS,   KC_7,    KC_8,    KC_9,    KC_TRNS, KC_LBRC,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                   KC_TRNS,   KC_4,    KC_5,    KC_6,    KC_TRNS, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LBRC, KC_RBRC, KC_TRNS,   KC_1,    KC_2,    KC_3,    KC_TRNS, KC_RSFT,
                                KC_TRNS, MO(_LOWER), KC_TRNS, KC_TRNS, KC_TRNS, KC_DEL, MO(_RAISE), KC_TRNS
    ),
    [_LOWER] = LAYOUT(
    ...
    [_ADJUST] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_KB_MUTE,        XXXXXXX, XXXXXXX, XXXXXXX,
                                    KC_TRNS, MO(_LOWER), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(_RAISE), KC_TRNS
    ),
    [_QWERTY_SWE] = LAYOUT(
